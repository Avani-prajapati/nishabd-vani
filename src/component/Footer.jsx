    ...
    <footer className="bg-slate-900 text-white py-6">
      <div className="min-w-full mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 border-b border-gray-700 pb-6 mb-4">
          ...
          <div>
            <p className="text-sm font-semibold text-white hover:text-gray-300 transform transition duration-300 hover:scale-105">SIH 2024 Project</p>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="flex items-center space-x-2 hover:text-blue-500 transform text-sm transition duration-300 hover:scale-110"
              >
            ...
            <div className="flex space-x-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex text-sm items-center space-x-2 hover:text-blue-700 transform transition duration-300 hover:scale-110"
              >
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li className="hover:underline text-sm hover:text-gray-300 transform transition duration-300">Shreve - Web App Designer</li>
